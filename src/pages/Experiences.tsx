...
const experienceCategories = [
  ...
  },
  {
    ...
    slug: "theme-parks",
    icon: FerrisWheel,
    description: "World-class theme parks including Dubai Parks, IMG Worlds, and Atlantis Aquaventure",
  ...
  },
  {
    ...
    icon: Building2,
    description: "Breathtaking views from Burj Khalifa, Dubai Frame, and Sky Views Observatory",
  ...
  },
  {
    ...
    slug: "water-sports",
    icon: Waves,
    description: "Exciting water activities including jet skiing, flyboarding, and parasailing",
  ...
  },
  {
    ...
    slug: "city-tours",
    icon: MapPin,
    description: "Explore Dubai's landmarks, hidden gems, and cultural heritage sites",
  ...
  },
  {
    ...
    description: "Unforgettable culinary journeys from dhow cruises to sky-high restaurants",
  ...
  },
  {
    ...
    icon: Mountain,
    description: "Adrenaline-pumping activities like skydiving, zip-lining, and hot air balloons",
