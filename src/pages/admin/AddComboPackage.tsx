...
import { useCreateComboPackage, generateComboSlug, calculateComboPrice } from "@/hooks/useComboPackages";
...
const AddComboPackage = () => {
  ...
  useEffect(() => {
    if (watchName) {
      form.setValue("slug", generateComboSlug(watchName));
    }
  }, [watchName, form]);
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-3">
                ...
                <Button type="submit" className="flex-1" disabled={createCombo.isPending}>
                  {createCombo.isPending ? "Creating..." : "Create Package"}
                </Button>
              </div>
            </div>
          </div>
